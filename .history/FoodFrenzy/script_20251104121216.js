...
const menuData = [
    ...
    },
    {
        ...
        price: 6.99,
        image: 'https://images.unsplash.com/photo-1573140401552-388e68f0b37e?w=800&auto=format&fit=crop',
        dietary: ['vegetarian']
    },
    {
        id: 5,
    ...
    },
    {
        ...
        price: 17.99,
        image: 'https://images.unsplash.com/photo-1476124369491-c4d9d17e0c6e?w=800&auto=format&fit=crop',
        dietary: ['vegetarian']
    },
    {
        id: 16,
    ...
    // Beverages
    {
        ...
        price: 3.99,
        image: 'https://images.unsplash.com/photo-1523677011781-c91d1bbe1c80?w=800&auto=format&fit=crop',
        dietary: ['vegan']
    },
    {
        id: 24,
...
// Helper to render either an <img> tag (when an asset path is provided) or a fallback emoji/span
function renderImageHTML(image, alt = '') {
    if (typeof image === 'string' && (image.startsWith('assets/') || image.startsWith('./assets/') || image.startsWith('/assets/'))) {
